      ...
      <Container className="mt-4">
        <StyledCard>
          ...
          <Card.Body className="p-3">
            ...
            <Card className="mb-2">
              <Card.Body>
                ...
                <div className="d-flex align-items-center">
                  <Button variant="outline-primary" size="sm" href="https://cdn.wsform.com/wp-content/uploads/2020/06/education.csv" download className="d-flex align-items-center">
            ...
            <div
              className={`flex flex-col items-center justify-center border-2 border-dashed rounded-md mb-3 cursor-pointer transition-colors ${
